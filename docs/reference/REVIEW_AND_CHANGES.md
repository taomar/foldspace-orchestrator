...
| Documentation paths and reference | The two protocols move to `docs/protocol/`, the operator guide to `docs/guides/`, and this review to `docs/reference/`. [RUN_CONFIGURATION.md](../protocol/RUN_CONFIGURATION.md) supplies questionnaire/examples/reference, not a competing generated `RUN_CONFIG` store. Source launch prompts now obtain approval before discovery workers. |
...
| [OPERATOR_GUIDE.md](../guides/OPERATOR_GUIDE.md) | Start, interview/approve, steer, inspect, migrate and recover the working setup. |
